        ...
        <div class="row">
            <div class="col-12">
                <div class="banner">
                    ...
                    <div class="banner-text"> Москитные сетки созданы для нашего удобства и комфорта, для того, чтобы
                        защитить наше жилище от непрошенных гостей - мух и
                        комаров, не только создающих дискомфорт в помещении, но и являющихся распространителями инфекций
                        и переносчиками опасных
                        болезней. Москитные сетки защитят ваш дом от пожара из-за брошенных сверху окурков. Также
                        москитные сетки спасут от
                        вездесущего тополиного пуха и в большой степени задержат пыльцу других растений, что облегчит
                        жизнь аллергикам.
                    </div>
                </div>
            </div>
...
<div id="type-net" class="container m-b-1">
    <div class="row">
        <div class="col-12">
            <div class="title">Компания «Фабрика Жалюзи» представляет 4 вида москитных сеток</div>
        </div>
...
<div id="compl" class="container m-b-1">
    <div class="row">
        <div class="col-sm-7">
            ...
            <div class="btn-fj btn-fixed-w animated" data-toggle="modal" data-target="#complModal">Посмотреть набор
            </div>
        </div>
    </div>
</div>
...
<div id="rem" class="container m-b-1">
    <div class="row">
        <div class="col-sm-8 offset-sm-4">
            ...
            <div class="btn-fj btn-fixed-w animated" id="rem_btn" data-toggle="modal" data-target="#netModal"
                 data-id="31">Заказать
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            <div class="dost">
                ...
                <div class="sub-title m-b-1">Вы можете рассчитать доставку до вашего города в любой из транспортных
                    компаний, мы доставим до места отправки в нашем городе
        ...
        <div class="row">
            <div class="col-md-12 col-lg-9 offset-lg-3 col-xl-7 offset-xl-5">
                <div class="about-com">
                    ...
                    <div>Мы предлагаем только качественный товар, оптимальные цены на росийском рынке и кратчайшие сроки
                        изготовления продукта любой сложности. Наши контакты:
                    </div>
...
<div class="modal fade" id="dost-btn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="tr-com justify-content-between align-items-center d-flex">
                    <a href="https://tk-kit.ru/" target="_blank" rel="nofollow"><img
                                src="<?php echo get_template_directory_uri() ?>/images/kit.png" alt="kit"></a>
                    <a href="http://www.rateksib.ru/tarify" target="_blank" rel="nofollow"><img
                                src="<?php echo get_template_directory_uri() ?>/images/ratec.png" alt="ratec"></a>
                    <a href="https://pecom.ru/services-are/the-calculation-of-the-cost/?utm_source=google&utm_medium=cpc&utm_campaign=pec_dm_poisk_brend_russia&utm_term=ssilka_kalkulator&gclid=CjwKCAjw2rjcBRBuEiwAheKeL9gtfEI4oi3NRB6X7jmtr_OuobzUCrsp9WWxWxFMGFyzs0QhigsKTBoCflgQAvD_BwE"
                       target="_blank" rel="nofollow"><img
                                src="<?php echo get_template_directory_uri() ?>/images/pec.png" alt="pec"></a>
                    <a href="https://m.dellin.ru/requests/" target="_blank" rel="nofollow"><img
                                src="<?php echo get_template_directory_uri() ?>/images/del.png" alt="del"></a>
                </div>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="complModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="error-compl-valid-result">Ошибка валидации, проверьте введенные данные!</div>
                <div class="form-modal">
                    ...
                    <div class="form-modal-inp">
                        <form action="" method="post">
                            ...
                            <div id="widget-compl"></div>
                            <div class="buyZav" id="buyCompl">Заказать</div>
                        </form>
                    </div>
                </div>
            </div>
